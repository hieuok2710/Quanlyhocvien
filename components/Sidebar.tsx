...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView, userProfile, isMobile = false }) => {
  ...
  return (
    <>
      ...
      {!isMobile && (
        <div className="hidden md:flex h-screen w-72 bg-white dark:bg-[#0B1121] flex-col shadow-2xl z-20 relative overflow-hidden border-r border-slate-200 dark:border-white/5 transition-colors duration-300">
